...
**************************************************************
*relxpert: +h0      =  83413   m0      = 1.9603       nn0     =  """
# nn0 = 0.34775 
fragment2 = """   hgd     = 0.49678
...
def writeNxNnetList(outDir,data1,data2 = ' '):
    ...
    for pram1 in data1:
        for pram2 in data2:
            ...
            listName = outDir+ '/'+ str(pram1) + '_' + str(pram1) + '_' + str(count) + '.ckt'
            count+=1            
...
if __name__ == "__main__":
    writeNxNnetList('outNetList', randomdata.nn0_random)
